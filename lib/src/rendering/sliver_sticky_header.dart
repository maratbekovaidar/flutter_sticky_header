...
class RenderSliverStickyHeader extends RenderSliver with RenderSliverHelpers {
  ...
  void performLayout() {
    ...
    if (child == null) {
      ...
      /// ! отвечает за расположение child
    ...
    if (header != null) {
      ...
      /// ! Эта переменная определяет позицию header'а вдоль оси прокрутки,
      ...
      if (!_sticky) {
        ...
        _isPinned = constraints.scrollOffset < childScrollExtent ||
            constraints.remainingPaintExtent == constraints.viewportMainAxisExtent;
      } else {
      ...
      /// ! отвечает за расположение header, именно отрисовку
      switch (axisDirection) {
        case AxisDirection.up:
          if (_reverse) {
  ...
  double childMainAxisPosition(RenderObject? child) {
    if (child == header) {
      if (_reverse) {
        return _isPinned ? constraints.viewportMainAxisExtent - _headerExtent! : constraints.scrollOffset;
      } else {
    ...
    if (geometry!.visible) {
      if (child != null && child!.geometry!.visible) {
        ...
        final Offset childOffset =
            _reverse ? offset - childParentData.paintOffset : offset + childParentData.paintOffset;
